...
| Pacote do cache offline | v76 | `VERSION` em `service-worker.js` |
...
| Cache | Conteúdo |
|---|---|
| `financas-cache-v76` | HTML do app, CSS, JavaScript, PDF.js, fontes locais, manifesto e ícones |
| `financas-pages-v76` | Landing e outras navegações públicas |
| `financas-fonts-v76` | Reserva para fontes externas; vazio hoje porque `FONT_HOSTS` está vazio |

No pacote publicado, cada nome recebe ainda o SHA-256 integral da publicação
depois de `v76`. Isso faz duas versões coexistirem durante a instalação sem que
